...
const Proyecto = () => {
    ...
    useEffect(()=>{
        ...
        socket.on("tarea estado", nuevoEstadoTarea => {
            ...
            <>
                ...
                {admin && (          
                    <button
                        ...
                        type="button"
                        className="text-sm px-5 py-3 w-full md:w-auto rounded-lg uppercase font-bold bg-green-500 text-white text-center mt-5 flex gap-2 items-center justify-center"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
